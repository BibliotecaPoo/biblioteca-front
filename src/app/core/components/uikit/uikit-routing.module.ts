...
@NgModule({
    imports: [RouterModule.forChild([
        ...
        // { path: 'overlay', data: { breadcrumb: 'Overlay' }, loadChil000dren: () => import('./overlays/overlaysdemo.module').then(m => m.OverlaysDemoModule) },
        { path: 'panel', data: { breadcrumb: 'Panel' }, loadChildren: () => import('./panels/panelsdemo.module').then(m => m.PanelsDemoModule) },
        // { path: 'table', data: { breadcrumb: 'Table' }, loadChildren: () => import('../pages/table/tabledemo.module').then(m => m.TableDemoModule) },
